...
public class TC11_PercentageOfProduct extends SampleTestSuiteBase {
	...
	log.info("STEP#2: Clicking on the pass percent of the product");
	...
	log.info("STEP#5: Validating the product snapshot text");
	...
	log.info("STEP#7: Validating the recent runs text");
	...
	log.info("STEP#12: Creating a list to display the test cases of the product");
	    String testcases=propReader.getValue("loc.testcase.txt");
		List<WebElement> passpercentagelist = browser.getFindFromBrowser().findElementsByXpath(testcases);
	...
	log.info("STEP#15: Creating a list to display the test cases after sorting");
		List<WebElement> passpercentlist = browser.getFindFromBrowser().findElementsByXpath(testcases);
